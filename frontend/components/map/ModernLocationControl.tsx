      ...
      >
        ...
        {accMeters !== null && (
          <button
            ...
            style={{
              ...
              color: accMeters <= 25 ? '#059669' : accMeters <= 75 ? '#2563EB' : '#D97706',
              fontSize: '11.5px',
              fontWeight: 700,
              cursor: 'pointer',
              display: 'inline-flex',
        ...
        <button
          ...
          style={{
            ...
            width: '34px',
            borderRadius: '50%',
            backgroundColor: isFollowing ? '#2563EB' : 'rgba(255, 255, 255, 0.96)',
            backdropFilter: 'blur(10px)',
            border: isFollowing ? '1px solid #1D4ED8' : '1px solid #E2E8F0',
